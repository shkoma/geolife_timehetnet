...
##### Train - Validation user list
    train_list = train_user_list
    test_list = test_user_list
#######################################################################################################################
    ...
    if is_train == True:
        ...
        #------- Init Wandb -------
        wandb_name = str(fold_user_list[fold_index]) + '_user'
        wandb.init(name=wandb_name, project='geolife_timehetnet', config=config)
