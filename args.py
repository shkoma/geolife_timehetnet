...
def argument_parser():
    ...
    parser.add_argument('--min_f', help='Minimum number of channels to sample', default=3   , type=int)
    parser.add_argument('--max_f', help='Maximum number of channels to sample', default=3   , type=int)

    parser.add_argument('--min_ft', help='Minimum number of channels to sample in test', default=3   , type=int) # 5
    parser.add_argument('--max_ft', help='Maximum number of channels to sample in test', default=3   , type=int)
    ...
    parser.add_argument('--dims',        help='A list of model weights for hetnet', default="[256,256,256]", type=str)
    parser.add_argument('--dims_pred',   help='A list of model weights for hetnet pred', default="[256,256,256]", type=str)
    ...
    parser.add_argument('--patience'   , help='patience for early stopping', default=3   , type=int)
