...
def getGens (args, model_type, load_test=False, onlyTest=False):
    ...
    # splits = np.load(f"{args.split_dir}/splits_test.npy",allow_pickle=True)[split_idx]
    
    # splits = [['Monash/Rideshare.npy'], #, 'Monash/Covid.npy', 'Monash/Traffic.npy'], 
    #           ['UEA_multivariate/x/SelfRegulationSCP2_x.npy'], 
    #           ['UEA_multivariate/x/HandMovementDirection_x.npy',
    #            'Monash/Rideshare.npy']]
    
    # './data/../Data/000/npy/000.npy'
    splits = [['geolife/Data/000/npy/000.npy'],
              ['geolife/Data/001/npy/001.npy'],
              ['geolife/Data/002/npy/002.npy']]
...
def fixedTestSet(args,f_size=5): #,forecast=False):
    ...
    if args.control_mode:
        ...
        # data_set = np.load(f"splits/torch_control_test.npy", allow_pickle=True)
